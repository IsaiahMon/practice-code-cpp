...
public:       
  ...
  void movesInWith(Person* newRoomate) {
    if(newRoomate != this){ //Make sure you arent moving in with yourself
      if(roomie){
	cerr << "Failed: " << name << " already has a roomie" << endl;;
      }
      if(newRoomate ->roomie){
	cerr << "Failed: " << newRoomate -> getName() << " already has a roomie" << endl;
      }
      else{
	...
	newRoomate -> roomie = this;    // and now they do too
      ...
      cerr << "Failed: " << name << " can't live with themself!";
  }       
...
int main(){
  ...
  Person joeBob("Joe Bob"), billyJane("Billy Jane"), marySue("Mary Sue"), danJohn("Dan John");         

  // now model these two becoming roommates       
  joeBob.movesInWith(&billyJane); 
  marySue.movesInWith(&danJohn); 
    
    
  // did this work out?       
  cout << joeBob.getName() << " lives with " << joeBob.getRoomiesName() << endl;
  cout << billyJane.getName() << " lives with " << billyJane.getRoomiesName() << endl;
  cout << marySue.getName() << " lives with " << marySue.getRoomiesName() << endl;
  cout << danJohn.getName() << " lives with " << danJohn.getRoomiesName() << endl;
    
  joeBob.movesInWith(&danJohn); 
